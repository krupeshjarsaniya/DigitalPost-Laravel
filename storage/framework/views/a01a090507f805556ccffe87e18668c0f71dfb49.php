                           ...
                           <?php $__currentLoopData = $businesses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $business): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <p>OLD : <?php echo e($business->busi_name); ?></p>
                                        <p>New : <?php echo e($business->busi_name_new); ?></p>
                                    </td>
                                    <td>
                                        <button type="button" onclick="approvebusiness('<?php echo e($business->busi_id); ?>')" class="btn btn-primary">Approve</button>
                                        <button type="button" onclick="declinebusiness('<?php echo e($business->busi_id); ?>')" class="btn btn-danger">Decline</button>
                                    </td>
                                </tr>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/digital-post/modules/User/Resources/views/approval.blade.php ENDPATH**/ ?>