...
<div class="row">
    <div class="col-md-12" id="addVideo" style="display: none;">
        <div class="card">
            ...
            <form id="categotyform" name="categotyform" action=<?php echo e(route('addnewvideopost')); ?> method="post" enctype='multipart/form-data'>
                <div class="card-body">
                    <div class="row">
    ...
    <div class="col-md-12" id="viewVideosList">
        ...
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">Tranding Video List
                </h4>
            </div>
            <div class="card-body">
                <div class="table-responsive">
                    <table class="display table table-striped table-hover text-center" id="tranding-post-table">
                        <thead>
                            <tr>
                                <th>No</th>
                                <th>Name</th>
...
<?php $__env->startSection('js'); ?>
    <script type="text/javascript" src="<?php echo e(url('/public/admin/js/user/newvideo.js?v='.rand())); ?>"></script>
    <script>
        function photos(e) {
        console.log(e.id);
