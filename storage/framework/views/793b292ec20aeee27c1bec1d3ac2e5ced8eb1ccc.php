		...
		<div class="sidebar-content">
			...
			<ul class="nav nav-primary">
				<?php $__currentLoopData = $menus; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $menu): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
					<?php if(Helper::checkRoutePermission(Auth::user()->user_role, $menu->id)): ?>
				...
				<?php endif; ?>
				<li class="nav-item">
					<a class="collapsed" href="<?php echo e(route('logout')); ?>" onclick="event.preventDefault();
...
</div><?php /**PATH /opt/lampp/htdocs/digital-post/resources/views/admin/layouts/sidebar.blade.php ENDPATH**/ ?>