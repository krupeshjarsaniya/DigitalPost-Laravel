...
<?php $__env->startSection('js'); ?>
    <script type="text/javascript" src="<?php echo e(url('/public/admin/js/user/adminuserlist.js?v='.rand())); ?>"></script>
    <script type="text/javascript" src="<?php echo e(url('/public/admin/js/user/admin-user-political.js?v='.rand())); ?>"></script>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/digital-post/modules/User/Resources/views/adminuserslist.blade.php ENDPATH**/ ?>