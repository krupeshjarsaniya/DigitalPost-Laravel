...
<div class="row">
    <div class="col-md-12" id="addCategory" style="display: none;">
        <div class="card">
            ...
            <form id="categotyform" name="categotyform" action=<?php echo e(route('addcategory')); ?> method="post" enctype='multipart/form-data'>
            <div class="card-body">
                <div class="row">
...
<?php $__env->startSection('js'); ?>
    <script type="text/javascript" src="<?php echo e(url('/public/admin/js/user/customcat.js?v='.rand())); ?>"></script>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/digital-post/modules/Festival/Resources/views/custom.blade.php ENDPATH**/ ?>