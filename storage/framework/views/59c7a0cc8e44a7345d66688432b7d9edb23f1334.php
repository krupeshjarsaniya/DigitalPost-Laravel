    ...
    <div class="wrapper">
        <div class="main-header">
            <div class="logo-header" data-background-color="blue">
                <a href="<?php echo e(route('distributors.dashboard')); ?>" class="logo">
            ...
            <?php echo $__env->make('distributor.layouts.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>

        </div>

            <?php echo $__env->make('distributor.layouts.sidebar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        ...
        <div class="main-panel">
            <div class="content">
                ...
                <?php echo $__env->make('distributor.layouts.footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        </div>
    </div>
...
<?php /**PATH /opt/lampp/htdocs/digital-post/resources/views/distributor/layouts/app.blade.php ENDPATH**/ ?>