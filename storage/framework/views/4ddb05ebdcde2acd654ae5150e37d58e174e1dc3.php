...
<div class="text-right mb-3">
    <a href="<?php echo e(route('musicCategory')); ?>" class="btn btn-danger text-white">Back</a>
</div>
    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title"><?php echo e($category->name); ?> Musics
...
<script type="text/javascript" src="<?php echo e(url('/public/admin/js/user/music.js?v='.rand())); ?>"></script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/digital-post/modules/User/Resources/views/music.blade.php ENDPATH**/ ?>