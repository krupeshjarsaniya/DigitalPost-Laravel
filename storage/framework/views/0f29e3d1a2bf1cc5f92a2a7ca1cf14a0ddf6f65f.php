								...
								<div class="dropdown-user-scroll scrollbar-outer">
									<li>
										<div class="user-box">
											...
											<div class="u-text">
												<h4> <?php if(!empty(Auth::user()->distributor->full_name)): ?>
													<?php echo e(Auth::user()->name); ?>

												</h4>
												<p class="text-muted"><?php echo e(Auth::user()->distributor->email); ?></p>
												<?php endif; ?>
											</div>
										</div>
									</li>
									<li>
										...
										<div class="dropdown-divider"></div>
										<a class="dropdown-item" href="<?php echo e(route('distributors.logout')); ?>" onclick="event.preventDefault();
...
<?php /**PATH /opt/lampp/htdocs/digital-post/resources/views/distributor/layouts/header.blade.php ENDPATH**/ ?>