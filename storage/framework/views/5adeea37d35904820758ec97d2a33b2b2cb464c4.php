...
<div class="row">
    <div class="col-md-12" data-id="<?php echo e($fest_id); ?>" id="addfestival" style="display: none;">
        <div class="card">
            <div class="card-header">
                <div class="card-title" id="country-title">Add Festival</div>
            </div>
            <form id="countryform" name="countryform" action="<?php echo e(route('addnewFestivalPost')); ?>" method="post" enctype='multipart/form-data'>
            <?php echo csrf_field(); ?>
...
<?php $__env->startSection('js'); ?>
    <script type="text/javascript" src="<?php echo e(url('/public/admin/js/user/newfestivalpost.js?v='.rand())); ?>"></script>
    <script>
