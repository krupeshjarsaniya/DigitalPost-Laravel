...
<div class="card">
    <div class="card-header">
        <div class="row">
            ...
            <div class="col-6">
                <a href="<?php echo e(route('frame')); ?>" class="btn btn-danger float-right">Back</a>
            </div>
        </div>
    </div>
    <div class="card-body">
        <div class="row">
        <div class="col-md-4">
            <input type="hidden"  id="frame_id" value="<?php echo e($frame->id); ?>">
            <img src="<?php echo e($frame->frame_image); ?>" id="loading" height="100px" width="100px">
        </div>
        <div class="col-md-4">
            <label>Frame Type: </label>
            <b><?php echo e($frame->frame_type); ?></b>
        </div>
        <div class="col-md-4">
            <label>Status: </label>
            <?php if($frame->is_active == 1): ?>
                <b>Active</b>
            <?php else: ?>
                <b>Inactive</b>
            <?php endif; ?>
        ...
        <div class="modal-content">
            <form name="addComponentForm" id="addComponentForm">
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-6">
                            <input type="hidden" name="frame_id" id="frame_id" value="<?php echo e($frame->id); ?>">
                            <div class="form-group err_image_for">
                                <label>Component For</label>
                                <select class="form-control" name="image_for" id="image_for">
                                    <option value="0">Other</option>
                                    <?php $__currentLoopData = $image_fields; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $field): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($field->id); ?>"><?php echo e($field->field_value); ?></option>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group err_text_for">
                                ...
                                <select class="form-control" name="text_for" id="text_for">
                                    ...
                                    <?php $__currentLoopData = $text_fields; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $field): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($field->id); ?>"><?php echo e($field->field_value); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group err_font_name">
                                ...
                                <select class="form-control" name="font_name" id="text_font_name">
                                    <?php $__currentLoopData = App\FrameText::$fontList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $font): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="col-md-6">
                            <div class="form-group err_field_three">
                                ...
                                <select class="form-control" name="field_three" id="text_field_three">
                                    <?php $__currentLoopData = App\FrameText::$textAligns; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $text): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/digital-post/modules/User/Resources/views/addlayers.blade.php ENDPATH**/ ?>