        ...
        <div class="login-aside w-100 d-flex align-items-center justify-content-center" style="">
            ...
            <div class="container container-login container-transparent animated fadeIn " style="background-color: #fff;box-shadow: -1px 3px 3px 3px #ccc;"   >
                ...
                <h3 class="text-center theme-font-color">Sign Up To Distributor </h3>
                 ...
                 <form method="POST" name="registerForm" onsubmit="return false" aria-label="<?php echo e(__('Register')); ?>">
                    ...
                    <div class="login-form">
                       ...
                       <div class="form-group err_email">
                        ...
                        <div class="form-group form-action-d-flex mb-3 justify-content-center">
                            ...
                            <span>Already have an account? <a href="<?php echo e(route('distributors.loginForm')); ?>">Login</a></span>
...
<?php $__env->startSection('js'); ?>
    <script>
        ...
        function register() {
            ...
            $.ajax({
                type: 'POST',
                url: "<?php echo e(route('distributors.register')); ?>",
                processData: false,
                contentType: false,
                dataType: 'json',
                data: formData,
                ...
                success: function (data)
                {
                    ...
                    if(data.status) {
                        window.location.href = "<?php echo e(route('distributors.loginForm')); ?>"
                    }
                    alert(data.message);
                }
            });
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/digital-post/resources/views/distributor/auth/register.blade.php ENDPATH**/ ?>