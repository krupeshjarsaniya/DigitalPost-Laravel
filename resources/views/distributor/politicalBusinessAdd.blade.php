        ...
        <form onsubmit="return false;" name="addPoliticalBusinessForm" enctype="multipart/form-data">
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 form-group err_pb_party_logo">
                    ...
                    <input type="file" onchange="changeFile(this)" name="pb_party_logo" id="pb_party_logo" class="form-control"><br>
                ...
                <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 form-group err_pb_party_logo_dark">
                    ...
                    <input type="file" onchange="changeFile(this)" name="pb_party_logo_dark" id="pb_party_logo_dark" class="form-control"><br>
                ...
                <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 form-group err_pb_watermark">
                    ...
                    <input type="file" onchange="changeFile(this)" name="pb_watermark" id="pb_watermark" class="form-control"><br>
                ...
                <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 form-group err_pb_watermark_dark">
                    ...
                    <input type="file" onchange="changeFile(this)" name="pb_watermark_dark" id="pb_watermark_dark" class="form-control"><br>
                ...
                <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 form-group err_pb_left_image">
                    ...
                    <input type="file" onchange="changeFile(this)" name="pb_left_image" id="pb_left_image" class="form-control"><br>
                ...
                <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 form-group err_pb_right_image">
                    ...
                    <input type="file" onchange="changeFile(this)" name="pb_right_image" id="pb_right_image" class="form-control"><br>
