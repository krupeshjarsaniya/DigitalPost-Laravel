        ...
        <form onsubmit="return false;" name="addBusinessForm" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 form-group err_busi_logo">
                            ...
                            <input type="file" onchange="changeFile(this)" name="busi_logo" id="busi_logo" class="form-control"><br>
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 form-group err_busi_logo_dark">
                            ...
                            <input type="file" onchange="changeFile(this)" name="busi_logo_dark" id="busi_logo_dark" class="form-control"><br>
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 form-group err_watermark_image">
                                ...
                                <input type="file" onchange="changeFile(this)" name="watermark_image" id="watermark_image" class="form-control"><br>
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 form-group err_watermark_image_dark">
                                ...
                                <input type="file" onchange="changeFile(this)" name="watermark_image_dark" id="watermark_image_dark" class="form-control"><br>
