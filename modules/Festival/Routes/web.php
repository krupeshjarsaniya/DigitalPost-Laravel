...
Route::prefix('businesscategory')->middleware('auth','adminauth')->group(function() {
    Route::get('/', function(){
        ...
        return view("festival::businesscategory",['language'=>$language, 'festivals'=> $festivals]);})->name('businesscategory');
...
Route::get('/', function(Request $request){
        ...
        $language = Language::where('is_delete','=',0)->get();
        return view("festival::newfestivalpost",['language'=>$language, 'fest_id' => $fest_id]);})->name('FestivalPost');
