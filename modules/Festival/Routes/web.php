...
Route::prefix('festival')->middleware('auth', 'adminauth')->group(function () {
    ...
    Route::get('customcatpost', function () {
        return view("festival::customcatpost");
    })->name('customcatpost');
    ...
    Route::get('videopost', function () {
        return view("festival::videopost");
    })->name('videopost');
    ...
    Route::get('newvideopost', function () {
        ...
        return view("festival::newvideopost", ['language' => $language]);
    })->name('newvideopost');
...
Route::prefix('businesscategory')->middleware('auth', 'adminauth')->group(function () {
    ...
    Route::get('/', function () {
        $language = Language::where('is_delete', '=', 0)->get();
        $festivals = Festival::where('fest_is_delete', 0)->orderBy('fest_id', 'DESC')->get();
        return view("festival::businesscategory", ['language' => $language, 'festivals' => $festivals]);
    ...
    Route::get('categorylist', 'BusinessCategory@ShowCategory');
...
Route::prefix('FestivalPost')->middleware('auth', 'adminauth')->group(function () {
    ...
    Route::get('/', function (Request $request) {
        $fest_id = isset($request->fest_id) ? $request->fest_id : 0;
        $language = Language::where('is_delete', '=', 0)->get();
        return view("festival::newfestivalpost", ['language' => $language, 'fest_id' => $fest_id]);
    })->name('FestivalPost');
...
Route::prefix('CustomCategorypost')->middleware('auth', 'adminauth')->group(function () {
    ...
    Route::get('/', function () {
        $language = Language::where('is_delete', '=', 0)->get();
        return view("festival::customcategorypost", ['language' => $language]);
    })->name('CustomCategorypost');
