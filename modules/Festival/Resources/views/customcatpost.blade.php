...
<div class="row">
    <div class="col-md-12" id="addCategory" style="display: none;">
        <div class="card">
            ...
            <form id="categotyform" name="categotyform" action={{route('addcatpost')}} method="post" enctype="multipart/form-data" onsubmit="return validateForm()">
            <div class="card-body">
                <div class="row">
...
@endsection
@section('js')
    <script type="text/javascript" src="{{ url('/public/admin/js/user/customcatpost.js?v='.rand()) }}"></script>
@endsection