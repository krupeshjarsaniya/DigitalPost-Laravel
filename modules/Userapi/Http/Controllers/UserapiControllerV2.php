...
class UserapiControllerV2 extends Controller
{
    ...
    public function getthisMonthsFestival(Request $request){
        ...
        for ($i=0; $i < sizeof($incedents); $i++) { 
            ...
            $photo = Post::where('post_category_id','=',$incedents[$i]['fest_id'])->where('post_is_deleted','=',0)->select('post_content','post_id','post_category_id')->orderBy('post_id','DESC')->offset(0)->limit(10)->get();
