                            ...
                            {{-- @for ($i = 0; $i < count($businesses); $i++) --}}
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <p>OLD : {{ $business->pb_name }}</p>
                                        <p>New : {{ $business->pbal_name }}</p>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <button type="button" onclick="approvebusiness('{{ $business->pb_id }}')" class="btn btn-primary">Approve</button>
                                        <button type="button" onclick="declinebusiness('{{ $business->pb_id }}')" class="btn btn-danger">Decline</button>
                                    </td>
                                </tr>
...
@endsection
@section('js')
    <script type="text/javascript" src="{{ url('/public/admin/js/user/user-political.js?v='.rand()) }}"></script>
    <script>
